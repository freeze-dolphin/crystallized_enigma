      ...
      scene.each do |e|
        if e[1]
          ...
          when "main"
            ...
            draw_char(font_wqy, "R", 50, 430)
            draw_char(font_wqy, "B", 50, 150)
            draw_char(font_wqy, "G", 340, 150)
            draw_char(font_wqy, "Y", 340, 430, size = 16, color = SF::Color::Black)
          when "tiled"
          end
        end
      end
